...
xlabel = "Length"
ylabel = "Period"
xlabel_residuals = "Residual of Length"
ylabel_residuals = "Residual of Period"
...
plt.title("Relationship between length and period", fontsize = 14)
...
plt.title("Residual of relationship between length and period", fontsize = 14)
# HERE is where you change how your graph is labelled!
...
plt.xlabel(xlabel, fontsize=14)
plt.ylabel(ylabel, fontsize=14)
plt.title("Relationship between length and period on loglog", fontsize = 14)
# HERE is where you change how your graph is labelled!
...
plt.xlabel(xlabel_residuals, fontsize=14)
plt.ylabel(ylabel_residuals, fontsize=14)
plt.title("Residual of relationship between length and period on loglog", fontsize = 14)
# HERE is where you change how your graph is labelled!
